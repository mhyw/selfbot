...
const mhywmhyw = "Chat to buy https://wa.me/6281238552767"
		...
		if (m.key.fromMe) {
			if (txt == "hi") {
				...
				if (Qimage) {
					const HUU = Qimage ? JSON.parse(JSON.stringify(m).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : m
					const media = await VH.downloadAndSaveMediaMessage(HUU, './media/' + m.key.id)
					Removebg(VH, to, media, mhywmhyw)
				}
			} else if (txt == "searchanime") {
				if (Qimage) {
					const HUU = Qimage ? JSON.parse(JSON.stringify(m).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : m
					const media = await VH.downloadAndSaveMediaMessage(HUU, './media/' + m.key.id)
					Searchanime(VH, to, media, mhywmhyw)
				}
				...
				if (vhani == "") {
					...
					if (cuj[0] == "profile") {
						try {
							...
							const response = await Requests(Host + '/tiktokprofile?query=' + cuj[1] + '&apikey=' + mhywmhyw)
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/tiktokhastag?query=' + cuj[1] + '&apikey=' + mhywmhyw)
							const pp = await response.json()
							const cok = pp.result
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/tiktokdl?link=' + cuj[1] + '&apikey=' + mhywmhyw)
							const pp = await response.json()
							const mek = pp.result
				...
				if (vhani == "") {
					...
					if (cuj[0] == "profile") {
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/igprofile?query=' + cuj[1] + '&apikey=' + mhywmhyw)
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/igstory?query=' + cuj[1] + '&apikey=' + mhywmhyw)
							const vez = await response.json()
						...
						try {
							...
							const response = await Requests(Host + '/ighighlight?query=' + hasil + '&apikey=' + mhywmhyw)
							const pp = await response.json()
						...
						try {
							...
							const hasil = barang[0]
							const value = Number(barang[1]) - 1
							const response = await Requests(Host + '/igtv?query=' + hasil + '&apikey=' + mhywmhyw)
						...
						try {
							...
							const hasil = barang[0]
							const value = Number(barang[1]) - 1
							const response = await Requests(Host + '/ighastag?query=' + hasil + '&apikey=' + mhywmhyw)
							const ve = await response.json()
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/instadl?link=' + cuj[1] + '&apikey=' + mhywmhyw)
							const ve = await response.json()
				...
				const response = await Requests(Host + "/fbdl?link=" + vhani + "&apikey=" + mhywmhyw)
				...
				if (vhani == "") {
					...
					if (cuj[0] == "search") {
						try {
							...
							const hasil = barang[0]
							const value = Number(barang[1]) - 1
							const response = await Requests(Host + '/youtube?query=' + hasil + '&apikey=' + mhywmhyw)
							const pp = await response.json()
							const cok = pp.result
							if (barang.length == 1) {
							...
							if (barang.length == 2) {
								const response = await Requests(Host + '/ytdl?link=https://youtu.be/' + cok[value].id + '&apikey=' + mhywmhyw)
								const ve = await response.json()
								const mek = ve.result
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/ytdl?link=' + cuj[1] + '&apikey=' + mhywmhyw)
							const ve = await response.json()
							const mek = ve.result
							let dat = "*_Detail YTDL*_\n"
							dat += "\nTitle: " + mek.title
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + "/ytmp3?query=" + jaran + "&apikey=" + mhywmhyw)
							const ve = await response.json()
							const mek = ve.result
				...
				const response = await Requests(Host + '/googlesearch?query=' + vhani + '&apikey=' + mhywmhyw)
				...
				const response = await Requests(Host + '/googleimg?query=' + hasil + '&apikey=' + mhywmhyw)
				const ppek = await response.json()
				...
				const response = await Requests(Host + '/playstore?query=' + vhani + '&apikey=' + mhywmhyw)
				const ppek = await response.json()
				const mek = ppek.result
				let no = 0
				let ve_ = "*Playstore*\n"
					...
					if (cuj[0] == "record") {
						...
						if (barang.length == 2) {
							try {
								...
								dat += "\n • Url: " + urel
								const response = await Requests(Host + '/getsmule?link=' + urel + '&apikey=' + mhywmhyw)
								const pp = await response.json()
								const mek = pp.result
								if (mek.Type === "audio") {
									await VHsendImageUrl(VH, to, mek.image, dat)
						...
						try {
							VHsendMessage(VH, to, 'please wait..')
							const response = await Requests(Host + '/getsmule?link=' + cuj[1] + '&apikey=' + mhywmhyw)
							const pp = await response.json()
							const mek = pp.result
							if (mek.Type === "audio") {
				...
				const response = await Requests(Host + "/starmakerdl?link=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				...
				const response = await Requests(Host + "/cocodownload?link=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				const cok = data.result
				VHsendVideoUrl(VH, to, cok.video, "*COCOFUN DOWNLOAD*")
			} else if (txt.startsWith("xxx-search")) {
				const vhani = txt.replace('xxx-search' + " ", "")
				const response = await Requests(Host + "/xxxsearch?query=" + vhani + "&apikey=" + mhywmhyw)
				...
				const response = await Requests(Host + "/xxxdownload?link=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				...
				const response = await Requests(Host + "/downloadfilm?judul=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result.data
				...
				const response = await Requests(Host + "/neonime_search?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				...
				const response = await Requests(Host + "/nekosearch?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/nekohentai&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*Neko Hentai*\n"
				for (var a = 0; a < asu.length; a++) {
				...
				const response = await Requests(Host + "/neko3d&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*Neko 3D*\n"
				for (var a = 0; a < asu.length; a++) {
				...
				const response = await Requests(Host + "/nekojavcosplay&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/nekonewepisode&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/nekojavlist&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/ongoinganoboy&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/music?query=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				const cok = data.result
				let dat = "*JOOX MUSIC*\n"
				for (var iu = 0; iu < cok.length; iu++) {
				...
				const response = await Requests(Host + "/liriklagu?query=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendMessage(VH, to, data.result.result)
			} else if (txt.startsWith("chord")) {
				const vhani = txt.replace('chord' + " ", "")
				const response = await Requests(Host + "/chordguitar?query=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendMessage(VH, to, data.result.result)
				...
				const hasil = barang[0]
				const value = Number(barang[1])
				const response = await Requests(Host + '/pinterest?query=' + hasil + '&apikey=' + mhywmhyw)
				const ppek = await response.json()
				const mek = ppek.result
				let num = 0
				for (var ere in mek) {
				...
				const response = await Requests(Host + "/zodiak?query=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				...
				const response = await Requests(Host + "/wikipedia?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/branly?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*VHSelfbot*\n\n" + asu.data
				VHsendMessage(VH, to, fox)
				...
				const response = await Requests(Host + "/kbbi?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*VHSelfbot*\n\n" + asu.hasil
				fox += "\n\n\nSource :" + asu.source
				...
				const response = await Requests(Host + "/calculator?value=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*VHSelfbot*\n\n" + asu.data
				fox += "\n\n\nInfo :\n" + asu.info
				...
				const response = await Requests(Host + "/weather?city=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*VHSelfbot*\n\n" + asu.weather
				fox += "\n" + asu.location
				...
				const response = await Requests(Host + "/infogempa&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/togel&apikey=" + mhywmhyw)
				const datas = await response.json()
				...
				const response = await Requests(Host + "/resepmasakan?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/gsmarena?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/quranlist?&apikey=" + mhywmhyw)
				const datas = await response.json()
				...
				const response = await Requests(Host + "/jadwalsholat?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/artinama?nama=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
			} else if (txt.startsWith("artimimpi")) {
				const vhani = txt.replace('artimimpi' + " ", "")
				const response = await Requests(Host + "/artimimpi?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = await Requests(Host + "/primbonjodoh?nama=" + fox + "&pasangan=" + vez + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
				...
				const vez = pemisah[1]
				const zal = pemisah[2]
				const response = await Requests(Host + "/ramalweton?tgl=" + fox + "&bln=" + vez + "&thn=" + zal + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
			} else if (txt.startsWith("nomor")) {
				const vhani = txt.replace('nomor' + " ", "")
				const response = await Requests(Host + "/nomerhoki?no=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
				...
				const vez = pemisah[1]
				const zal = pemisah[2]
				const response = await Requests(Host + "/harijadian?tgl=" + fox + "&bln=" + vez + "&thn=" + zal + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.hasil)
			} else if (txt == "herolistml") {
				const response = await Requests(Host + "/mlherolist?apikey=" + mhywmhyw)
				const data = await response.json()
				...
				const response = await Requests(Host + "/herodetail?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = "*Detail Hero*\n"
				fox += "*Title :* " + asu.title
				...
				const response = await Requests(Host + "/ipwhois?ipaddr=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/textscreen?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				VHsendMessage(VH, to, asu.text)
			} else if (txt.startsWith("ceritasex")) {
				const vhani = txt.replace('ceritasex' + " ", "")
				const response = await Requests(Host + "/cerita_sex&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				let fox = asu.judul
				fox += "\n" + asu.cerita
				...
				const response = Host + "/puisi_image&apikey=" + mhywmhyw
				VHsendImageUrl(VH, to, response, "*Puisi Image*")
			} else if (txt == "randompantun") {
				const response = await Requests(Host + "/random_pantun&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendMessage(VH, to, data.result.pantun)
			} else if (txt == "quoteid") {
				const response = await Requests(Host + "/quoteid&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendMessage(VH, to, data.result.kata)
			} else if (txt == "quotes") {
				const response = await Requests(Host + "/quotes?apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendMessage(VH, to, data.result.content)
			} else if (txt == "randomcat") {
				const response = await Requests(Host + "/randomcat?apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendImageUrl(VH, to, data.result.url, "*_Random Cat_*")
			} else if (txt == "randomnekonime") {
				const response = await Requests(Host + "/randomnekonime&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendImageUrl(VH, to, data.result.result, "*_Random Nekonime_*")
			} else if (txt == "randomloli") {
				const response = await Requests(Host + "/randomloli&apikey=" + mhywmhyw)
				const data = await response.json()
				VHsendImageUrl(VH, to, data.result.result, "*RANDOM LOLI*")
			} else if (txt == "randomwibu") {
				const response = await Requests(Host + "/randomwibu&apikey=" + mhywmhyw)
				const data = await response.json()
				...
				const response = await Requests(Host + "/shortener?link=" + vhani + "&apikey=" + mhywmhyw)
				const data = await response.json()
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/ssweb?link=" + fox + "&type=" + vez + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = await Requests(Host + "/distance?from=" + fox + "&to=" + vez + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				VHsendMessage(VH, to, datas.result.data)
			} else if (txt.startsWith("alamat")) {
				const vhani = txt.replace('alamat' + " ", "")
				const response = await Requests(Host + "/infoalamat?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/jadwalbola&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result.data
				...
				const response = await Requests(Host + "/infomotor?merk=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/infomobil?merk=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result
				...
				const response = await Requests(Host + "/otakusearch?query=" + vhani + "&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result.data
				...
				const response = await Requests(Host + "/otakulatest&apikey=" + mhywmhyw)
				const datas = await response.json()
				const asu = datas.result.data
				...
				const response = Host + "/write?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const hasil = barang[0]
				const value = Number(barang[1])
				const response = await Requests(Host + '/wasticker?query=' + hasil + '&apikey=' + mhywmhyw)
				const ppek = await response.json()
				...
				const response = Host + "/water_maker?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/fire_maker?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/metal_maker?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/balloonmaker?text1=" + fox + "&text2=" + vez + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/padlock?text1=" + fox + "&text2=" + vez + "&apikey=" + mhywmhyw
				...
				const response = Host + "/textxgif?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/slidingtext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/bannerff?title=" + fox + "&text=" + vez + "&apikey=" + mhywmhyw
				...
				const response = Host + "/logoff?hero=alok&text=" + vhani + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/logoml?hero=" + fox + "&text=" + vez + "&apikey=" + mhywmhyw
				...
				const response = Host + "/gamelogo?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/blackpinkicon?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/thundertext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/silktext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/partytext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/romancetext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const vez = pemisah[1]
				const zal = pemisah[2]
				const response = Host + "/googletext?text1=" + fox + "&text2=" + vez + "&text3=" + zal + "&apikey=" + mhywmhyw
				...
				const response = Host + "/glowtext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const response = Host + "/lovemessagetext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/glitchtext?text1=" + fox + "&text2=" + vez + "&apikey=" + mhywmhyw
				...
				const response = Host + "/galaxytext?text=" + vhani + "&apikey=" + mhywmhyw
				...
				const fox = pemisah[0]
				const vez = pemisah[1]
				const response = Host + "/pornlogo?text1=" + fox + "&text2=" + vez + "&apikey=" + mhywmhyw
				...
				const response = Host + "/hartatahta?text=" + vhani + "&apikey=" + mhywmhyw
